...
<head>
    ...
    <title>お問い合わせ｜ゑびすダイニング</title>
    <link rel="stylesheet" href="css/contact.css?<?= time() ?>">
</head>
<body>
    <?php $page="contact"; require('include/header.php'); ?>
    <div class="mv-sub">
        <div class="inner">
            <h2>お問い合わせ<span>Contact</span></h2>
            <div class="image">
                <picture>
                    <source media="(min-width: 1440px)" srcset="images/contact_mv_photo.jpg">
                    <source media="(max-width: 1439px)" srcset="images/contact_mv_photo_sp.jpg">
                    <img src="images/contact_mv_photo.jpg" alt="">
                </picture>
            </div>
        </div>
    </div>
    <section class="contact">
        <form class="inner" action="">
            ...
            <div class="row">
                ...
                <div class="field">
                    <input type="text" placeholder="株式会社〇〇食品サービス">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="field">
                    <div class="input-wrap">
                        <input class="short" type="text" placeholder="000">
                    </div>
                    <div class="input-wrap">
                        <input class="short" type="text" placeholder="000">
                    </div>
                    <input class="short l" type="text" placeholder="000">
                </div>
            </div>
            <div class="row">
